...
const Rococo = ({
  ...
  const tokenClicked = (assetClicked) => {
    ...
    if (assetClicked === 'BSX') {
      ...
      setRowBSX({ opacity: 0, clickable: 'none', backgroundColor: 'black' })
      setRowKAR({ opacity: 0, clickable: 'none', backgroundColor: 'black' })
      ...
      setRowBSX({ opacity: 1, clickable: 'none', backgroundColor: 'black' })
                    ...
                    {instructionStatus === 'Step1' ? (
                      <h4 className="fs-30 text-center mt-2">
                        <span style={{ color: 'white' }}>
                          Step 1 - Select The{' '}
                          <span style={{ color: 'yellow' }}>Asset</span> To
                          Transfer
                        </span>
                      </h4>
              ...
              <form className="form-wrapper mb-0">
                <div className="form-group mb-0">
                  ...
                  <div className="row" style={{ marginTop: '10px' }}>
                    <div
                      className="col-xl-4 col-xxl-4 col-lg-6 col-sm-6 px-3"
                      style={{
                        height: '50px',
                        padding: '2px',
                        cursor: 'pointer',
                    ...
                    >
                      <div className="row">
                        ...
                        <div
                          className="col-xl-6 col-xxl-4 col-lg-6 col-sm-6"
                          style={{ height: '75px' }}
                        >
                          <div
                  ...
                  >
                    <div
                      className="col-xl-4 col-xxl-4 col-lg-6 col-sm-6"
                      style={{ height: '70px', pointerEvents: `${stateOfBSX}` }}
                      onClick={() => tokenClicked('BSX')}
                    >
                      <div className="row">
                        <div className="col-xl-6 col-xxl-4 col-lg-6 col-sm-6"></div>
                        ...
                        >
                          <div
                            className="widget-stat card"
                            style={{
                              backgroundColor: `${rowBSX.backgroundColor}`,
                              borderWidth: '1px',
                              borderColor: '#5685e6',
                            }}
                          >
                    ...
                    <div
                      ...
                      style={{
                        height: '70px',
                        padding: '2px',
                        opacity: `${rowBSX.opacity}`,
                        transition: 'opacity 1s',
                        pointerEvents: `${rowBSX.clickable}`,
                      }}
                      onClick={() => BSX_chainTabClicked('Basilisk')}
                    >
                      <div
                        className="widget-stat card "
                        style={{
                          height: '100%',
                          backgroundColor: `${elemBSX[0].activebackgroundColor}`,
                          opacity: `${elemBSX[0].opacity}`,
                          transition: 'opacity 1s',
                          width: '100%',
                        }}
                      >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        transition: 'opacity 1s',
                        pointerEvents: `${
                          elemBSX[2].clickable === 'none' ||
                          rowBSX.clickable === 'none'
                            ? 'none'
                            : ''
                        }`,
                      }}
                      onClick={() => BSX_chainTabClicked('Karura')}
                    >
                      <div
                        className="widget-stat card "
                        style={{
                          height: '100%',
                          backgroundColor: `${elemBSX[2].activebackgroundColor}`,
                          opacity: `${elemBSX[2].opacity}`,
                          transition: 'opacity 1s',
                          width: '100%',
                        }}
                      >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        height: '70px',
                        padding: '2px',
                        opacity: `${rowPHA.opacity}`,
                        transition: 'opacity 1s',
                        pointerEvents: `${rowPHA.clickable}`,
                      }}
                    >
                      <div
                        className="widget-stat card "
