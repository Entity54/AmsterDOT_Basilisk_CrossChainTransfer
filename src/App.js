...
function App() {
  //#region
  const [relaySpecs, setRelaySpecs] = useState({
    api: undefined,
    chainID: undefined,
    blockNumber: undefined,
  })
  const [parachainSpecs, setParachainSpecs] = useState({
    api: undefined,
    chainID: undefined,
    blockNumber: undefined,
  })
  const [karuraAlphaSpecs, setKaruraAlphaSpecs] = useState({
    api: undefined,
    chainID: undefined,
    blockNumber: undefined,
  })

  const [setupSpecs, setSetupSpecs] = useState({
    wallet: null,
    provider: null,
    pair: null,
  ...
  const [polakdotAccountSigner, setPolakdotAccountSigner] = useState({
    injector: null,
    address: null,
  })
  //#endregion
  ...
  useEffect(() => {
    const runSetup = async () => {
      ...
      console.log(
        'api_kusama.consts.balances.existentialDeposit : ',
        api_kusama.consts.balances.existentialDeposit.toString(),
      )
      console.log(
        'api_moonriver.consts.balances.existentialDeposit : ',
        api_moonriver.consts.balances.existentialDeposit.toNumber(),
      )
      console.log(
        'api_karura.consts.balances.existentialDeposit : ',
        api_karura.consts.balances.existentialDeposit.toNumber(),
      )
